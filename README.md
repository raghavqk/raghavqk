...
### Aspiring AI/ML Engineer · LLMs, RAG & Agentic AI · TSEC Mumbai
...
- 🧠 Building toward AI Engineering, with a focus on **LLMs, RAG systems, and agentic AI workflows**
- 🎮 Currently building **GameSense AI** — an AI-powered gaming performance coach combining computer vision, ML, and an LLM coaching layer
- 📚 Currently leveling up with: PyTorch for Deep Learning (DeepLearning.AI)
...
![Groq](https://img.shields.io/badge/Groq_LLaMA3-F55036?style=for-the-badge&logo=groq&logoColor=white)
